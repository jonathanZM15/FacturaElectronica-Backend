...
<head>
    ...
    <title>🚫 Desactivación de su cuenta en Máximo Facturas</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f4f4f4;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 40px 20px;">
        <tr>
            <td align="center">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3);">
                    <!-- Header con logo -->
                    <tr>
                        <td align="center" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 40px 30px;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; color: #333333;">
                            ...
                            <p style="font-size: 16px; color: #4a5568; margin: 0 0 15px 0; line-height: 1.8;">
                                Le informamos que su cuenta en <strong>Máximo Facturas</strong> ha sido <strong>desactivada 🚫</strong> por un usuario con permisos de administración asociado a su emisor.
                            </p>

                            <p style="font-size: 16px; color: #4a5568; margin: 0 0 15px 0; line-height: 1.8;">
                                A partir de este momento, no podrá acceder al sistema ni realizar operaciones con su cuenta.
                            </p>
