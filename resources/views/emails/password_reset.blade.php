...
<head>
    ...
    <title>🔐 Restablecimiento de contraseña en Máximo Facturas</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f4f4f4;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%); padding: 40px 20px;">
        <tr>
            <td align="center">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; color: #333333;">
                            ...
                            <p style="font-size: 16px; color: #4a5568; margin: 0 0 15px 0; line-height: 1.8;">
                                Hemos recibido una solicitud para restablecer la contraseña de su cuenta en <strong>Máximo Facturas</strong> 🔐.
                            </p>
                                ...
                                <tr>
                                    <td style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px 20px; border-radius: 4px;">
                                        ...
                                        <p style="font-size: 14px; color: #92400e; margin: 8px 0 0 0;">
                                            Si usted no solicitó este cambio, puede ignorar este mensaje de forma segura. Su contraseña actual seguirá siendo válida.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="background: #f0fdf4; border-left: 4px solid #22c55e; padding: 15px 20px; border-radius: 4px;">
                                        <p style="font-size: 14px; color: #166534; margin: 0 0 8px 0;">
                                            <strong>🔒 Consejo de seguridad:</strong> Utilice una contraseña segura que contenga al menos 8 caracteres, incluyendo letras mayúsculas, minúsculas, números y símbolos. Nunca comparta su contraseña con nadie.
                                        </p>
                                        <p style="font-size: 14px; color: #166534; margin: 8px 0 0 0;">
                                            Máximo Facturas nunca le solicitará su contraseña por correo electrónico ni por teléfono.
                                        </p>
                                    </td>
                                </tr>
                            </table>
