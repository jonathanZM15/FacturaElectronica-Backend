...
<head>
    ...
    <title>✅ Reactivación de su cuenta en Máximo Facturas</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f4f4f4;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 40px 20px;">
        <tr>
            <td align="center">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; color: #333333;">
                            ...
                            <p style="font-size: 16px; color: #4a5568; margin: 0 0 15px 0; line-height: 1.8;">
                                Le informamos que su cuenta en <strong>Máximo Facturas</strong> ha sido <strong>reactivada ✅</strong> por un usuario con permisos de administración asociado a su emisor.
                            </p>

                            <p style="font-size: 16px; color: #4a5568; margin: 0 0 15px 0; line-height: 1.8;">
                                A partir de este momento, ya puede acceder nuevamente al sistema y continuar con sus operaciones con normalidad.
                            </p>

                            <!-- Información de contacto -->
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 25px 0;">
                                <tr>
                                    <td style="background: #f0fdf4; border-left: 4px solid #10b981; padding: 15px 20px; border-radius: 4px;">
                                        <p style="font-size: 14px; color: #166534; margin: 0;">
                                            Si tiene alguna duda o requiere asistencia, puede comunicarse con el emisor responsable asociado a su cuenta 🤝.
                                        </p>
                                    </td>
                                </tr>
                            </table>
